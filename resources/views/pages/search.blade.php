        ...
        <div class="search-card">
            ...
            <form action="{{ url('homepage/search') }}" method="get">
                ...
                <div id="filters" style="display: none;">
                    ...
                    <input type="radio" id="publicRadio" name="profileType" value="anyone">
                    <label for="publicRadio" class="radio-name">Anyone</label>
                    <input type="radio" id="privateRadio" name="profileType" value="follow">
                    <label for="privateRadio" class="radio-name">People that You follow</label>
                </div>
            ...
            <div id="spaces" class="search-page-results" style="overflow-y: auto;">
            ...
            <div id="comments" class="search-page-results" style="overflow-y: auto;">
            ...
            <div id="groups" class="search-page-results" style="overflow-y: auto;">
